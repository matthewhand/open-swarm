...
| [ADR-005](./005-local-computer-control.md) | Local computer control — adapt OMB + Rakazo (REQ-189 / #645) |
...
ADR-003 (desktop packaging) and ADR-004 (virtualized chat) are proposed on open PRs; this tree uses **005** so numbers do not collide.
