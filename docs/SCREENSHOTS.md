...
| `blueprint-library.png` | `/blueprint-library/` (Django) | `discover_blueprints()` catalog: Available **38**, pagination **Showing 12 of 38** + Show more, MCP badges (checking spinner); **≠** SPA API 45 / `swarm-cli list` 31 | USER_JOURNEY.md, GUIDED_TOUR.md | 2026-08-19 | current |
