...
| `spa-chat.png` | `/chat` (React SPA) | Websocket chat shell with blueprint selector (login required for consumer) | GUIDED_TOUR.md | 2026-08-18 | current |
...
| `sessions.png` | `/sessions/` (Django) | Session Explorer with demo rows + status chips (isolated store) | GUIDED_TOUR.md, SESSION_EXPLORER.md | 2026-08-18 | current |
| `session-detail.png` | `/sessions/resp_tour_hybrid/` (Django) | Seeded hybrid_team session graph + output | GUIDED_TOUR.md, SESSION_EXPLORER.md | 2026-08-18 | current |
| `profiles.png` | `/profiles/` (Django) | Isolated `local-gateway` LLM profile (Teams nav active) | GUIDED_TOUR.md | 2026-08-18 | current |
...
| `mobile/spa-chat.png` | `/chat` | Chat composer + dock clearance | 2026-08-18 | current |
...
| `mobile/sessions.png` | `/sessions/` | Session list with demo rows + status chips | 2026-08-18 | current |
| `mobile/session-detail.png` | `/sessions/resp_tour_hybrid/` | Seeded session detail + graph | 2026-08-18 | current |
| `mobile/profiles.png` | `/profiles/` | Isolated `local-gateway` profile; Teams tab active | 2026-08-18 | current |
...
| `docs/screenshots/webui/*` | Historical React Builder / panel stills (`/builder` is not a live SPA route) | `docs/examples/webui-config-panels.md` | mixed | stale |
