...
Quick Actions on the capture read **Launch Team**, **Browse Blueprints**,
**Manage Teams**, **Settings** (matches current `App.tsx`; recaptured after
`npm run build` on **2026-08-18**). Bare `/teams`, `/blueprints`, `/settings`, and
