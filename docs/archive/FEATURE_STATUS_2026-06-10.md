# Feature Status Audit (archived)

> **Historical.** Point-in-time evidence snapshot from 2026-06-10 (FOSS cleanup
> wave). Kept for lineage only — do not treat rows as current. Live board:
