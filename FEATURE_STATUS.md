...
| Agent sidepane hide | ✅ | `AgentSidebar` lists `/v1/blueprints` agents; right-click **Hide from sidebar** moves an item into expandable Hidden; Unhide restores it. Persist `localStorage.swarm_hidden_agents` (no hide-all). |
