...
| Survival CLI/API chat + self-update prove (REQ-79 / #424) | ✅ | Documented in `docs/requirements/REQ-79.md`. Proves in-app autonomous agent self-update workflow on `matthewhand/open-swarm` without Grok CoS dependency. Verifies CLI/API session resume and honest status notices. Tests: `tests/unit/test_req79_survival_self_update.py`. Fixes #424. |
