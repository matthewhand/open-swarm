...
| Creator toast DOM XSS escapes | ✅ | `team_creator.html` / `agent_creator_pro.js` escape untrusted names/errors/paths before `innerHTML`; pro preview capabilities + template tooltip also escaped; `tests/views/test_creator_toast_xss.py` |
