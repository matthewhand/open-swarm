"""Lock ADR-007 look-only computer-control proposal (REQ-189 / #645).
...
ADR = REPO / "docs" / "adr" / "007-local-computer-control.md"
ADR_INDEX = REPO / "docs" / "adr" / "README.md"
REQ = REPO / "docs" / "requirements" / "REQ-189.md"


def test_adr007_exists_and_is_look_only():
