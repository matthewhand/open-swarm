...
def test_settings_remotes_are_opt_in_not_live_lan_defaults():
    """REQ-59/62/63: Settings remotes are opt-in; no LAN inventory or placeholder panes."""
    ...
    assert "session_cookie_env" in sheet
