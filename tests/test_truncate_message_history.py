# tests/test_truncate_message_history.py

import logging
# ---> Explicitly set log level for the module being tested <---
# Keep this for debugging the truncation logic itself
...
# --- FIX: Import from the correct central utils ---
...
# Note: truncate_strict_token and truncate_preserve_pairs were likely old names/concepts
# The current logic uses truncate_message_history with environment variables for modes.
...
def run_truncation_test(input_messages, max_tokens, max_messages, expected_messages, mode="pairs", model="gpt-4", debug_tag=""):
    ...
    try:
        ...
        # Use the centrally imported function
