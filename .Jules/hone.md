...
## 2026-08-06 | [Architectural Audit] | Insight: Conditional unmounting of accessibility wrappers (like FocusTrap) abruptly rips elements from the DOM, severing CSS exit transitions and obscuring accessibility context from screen readers during the exit phase. | Protocol: Prefer rendering accessibility wrappers unconditionally and managing their state via control props (e.g., active={isOpen}) to preserve stateful DOM transitions.
