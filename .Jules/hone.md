...
## 2026-08-23 | [Architectural Audit] | Insight: Missing proper aria states on pending query wraps. | Protocol: Explicitly wrap loading query wrappers with aria-live='polite' and aria-busy='true'.
## 2026-08-23 | [Architectural Audit] | Insight: Modal backdrops use full-screen buttons instead of form dialog methods. | Protocol: Retain native <form method="dialog"> for backdrops to allow browsers to natively handle modal closing semantics without anti-patterns.
## 2026-08-23 | [Architectural Audit] | Insight: Accordions use custom div + checkbox hacks breaking native A11y focus. | Protocol: Refactor Accordions to use HTML5 semantic <details> and <summary> to guarantee native keyboard operability.
