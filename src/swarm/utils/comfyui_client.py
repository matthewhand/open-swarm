...
class ComfyUIClient:
    ...
    def generate_avatar(self,
                       ...
                       description: str,
                       category: str,
                       style: str = "professional") -> str | None:
        """
    ...
    def _submit_workflow(self, workflow: dict[str, Any]) -> str | None:
    ...
    def _wait_for_completion(self, prompt_id: str, blueprint_name: str) -> str | None:
