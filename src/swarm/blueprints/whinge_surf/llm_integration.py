...
class WhingeSurfLLMBackend:
    ...
    async def initialize(self):
        ...
        try:
            ...
            from swarm.core.llm_client import LLMClient
    ...
    async def analyze_code_quality(
        ...
        if not self.llm_client:
            await self.initialize()
            if not self.llm_client:
                return dict.fromkeys(criteria, "Not available (LLM not initialized)")
        ...
        try:
            ...
            try:
                ...
                return dict.fromkeys(criteria, "Analysis failed")
