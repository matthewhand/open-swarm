...
class GeeseSpinner:
    ...
    def __init__(self, console: Console, message: str = "Working...", interval: float = 0.15):
        ...
        self._thread: Optional[threading.Thread] = None # Type hint uses Optional
    ...
    def start(self, message: Optional[str] = None): # Type hint uses Optional
    ...
    def stop(self, final_message: Optional[str] = None): # Type hint uses Optional
