...
import { Home, Settings, Bot, Book, Users, PlusCircle, List } from 'lucide-react'
    ...
    <Router>
      ...
      >
        ...
        >
          ...
          <MobileTab href="/sessions/" icon={<List className="h-5 w-5" />} label="Sessions" />
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card compact bordered>
          <div className="stat !py-2 !min-h-0">
