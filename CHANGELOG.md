...
### Added
- **REQ-106 bee brand mark:** Colour + mono SVG masters in `assets/brand/` (silhouette honeybee from the README banner, not photo-real). Checked-in favicon 16/32/48, Apple 180 (plus 120/152), PWA 192/512; mono and mono-on-dark (`#111111`) rasters documented. SPA + Django tab / apple-touch-icon / manifest wired; `assets/images/favicon.ico` replaced. README hero JPG stays. Fixes #470.
