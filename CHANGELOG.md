...
### Added
- **REQ-189 look-only ADR-005:** local computer control — adapt OpenMausBot + Rakazo (browser / Docker sibling sandbox / host via placed remotes). SaaS deferred. Programme [#645](https://github.com/matthewhand/open-swarm/issues/645); this change does not close it.
